...
\textbf{DC and AC analysis}
for graphs you need for the voltage you need a measure point and for the current also,
no need for models for the lumped elements
add annotation tools to see A,V, mW and others
on the graph use the measure point on any place on the schematic, use MAG 
if you wanna look at the phase use the angle measure it is beisde dB this is the AC analysis also make frequencies sweep values for the AC 
on DC on graphs you need a measure device and also for the AC 


\section{From Vimo Awe software}
\subsection{Tlines}
\textbf{foloow the figures}
after you make the design  make a stackup then enable the model for the components for exteacton 
follow this channel on vimo for more detailed videos \href[options]{https://vimeo.com/awrtv/channels/moderated}{AWR software}
